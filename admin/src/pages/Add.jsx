  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
        ...
        <div  className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
            ...
            <div>
                <p className='mb-2'> Products Prices</p>
        ...
        <div>
            ...
            <div className='flex gap-3'>
                ...
                <div onClick={()=>setSizes(prev => prev.includes("32oz") ? prev.filter( item => item !== "32oz") : [...prev,"32oz"])}>
                    <p className={`${sizes.includes("32oz") ? "bg-pink-100" : "bg-slate-200"} px-3 py-1 cursor-pointer`}>32oz</p>
                </div>
            </div>
        </div>
        ...
        <div>
            ...
            <div className='flex gap-3'>
                ...
                <div onClick={()=>setColors(prev => prev.includes("Red") ? prev.filter( item => item !== "Red") : [...prev, "Red"])}>
                    <p className={`${colors.includes("Red") ? "bg-pink-100" : "bg-slate-200"} px-3 py-1 cursor-pointer`}>Red</p>
                </div>
                ...
                <div onClick={()=>setColors(prev => prev.includes("Pink") ? prev.filter( item => item !== "Pink") : [...prev, "Pink"])}>
                    <p className={`${colors.includes("Pink") ? "bg-pink-100" : "bg-slate-200"} px-3 py-1 cursor-pointer`}>Pink</p>
                </div>
                ...
                <div onClick={()=>setColors(prev => prev.includes("Tan") ? prev.filter( item => item !== "Tan") : [...prev, "Tan"])}>
                    <p className={`${colors.includes("Tan") ? "bg-pink-100" : "bg-slate-200"} px-3 py-1 cursor-pointer`}>Tan</p>
                </div>
                <div onClick={()=>setColors(prev => prev.includes("Camo") ? prev.filter( item => item !== "Camo") : [...prev, "Camo"])}>
                    <p className={`${colors.includes("Camo") ? "bg-pink-100" : "bg-slate-200"} px-3 py-1 cursor-pointer`}>Camo</p>
                </div>
                <div onClick={()=>setColors(prev => prev.includes("Regular") ? prev.filter( item => item !== "Regular") : [...prev, "Regular"])}>
                    <p className={`${colors.includes("Regular") ? "bg-pink-100" : "bg-slate-200"} px-3 py-1 cursor-pointer`}>Regular</p>
